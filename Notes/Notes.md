...
Its ia a neural network that is trained on a specific dataset to respond to an input sequence.
...
eg : eating dancing surfing -> eat dance surf with ing as suffix
